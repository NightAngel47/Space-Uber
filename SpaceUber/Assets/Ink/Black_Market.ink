An encrypted signal reaches your ship, its source less than a thousand kilometers off your current flight plan. The signal conveys the Universal characters for "wares of value," "bartering," and "critical discretion." Do you follow this signal?
* [Detour to Signal]
-> Black_Market
* [Carry on Mission]
You decide that whatever deals lie off the path are not likely not worth your time.
-> END
...
== Flashclones ==
The clones you purchased are entirely functional as crewmates, having sufficient brain plasticity to be trained to any task within the week. The black market, however, supplied you with no receipt of whose likeness the clones were modeled after. Clone production without their template's consent could easily catch you on an IP lawsuit, so keeping the new crew members off the books is ideal.
->END

==Nuclear_Weapons ==
Banned and re-banned for combat use every decade, nuclear weapons have somehow remained a mainstay in ship to ship combat for the duration of the space age. While highly effective, the launchers now attached to your ship are also highly illegal. Using them sparingly is advised.
-> END
