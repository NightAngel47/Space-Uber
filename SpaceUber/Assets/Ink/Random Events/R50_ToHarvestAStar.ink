The crew gasp at the sight upon the horizon. A circular structure encompasses a dim white dwarf, and seems to be draining the energy from the celestial body. It appears old and worn, with some of its interior exposed. As the ship gets closer its power begins to steadily drain. The structure seems to gather and store energy from any suitable source within range. You manage to dock on the structure before losing power completely. The star appears to flicker as you ponder how to handle the situation.
...
->DONE
== Repair ==
The crew need to salvage some scrap from the hull. But still manage to make the necessary repairs. The structure hums with new life and seems to have stabilized. Your crew return with some power cells that you use to restart the ship. You swiftly depart, wondering if the repairs have made a difference, as the dim light of the star disappears behind you.
->DONE