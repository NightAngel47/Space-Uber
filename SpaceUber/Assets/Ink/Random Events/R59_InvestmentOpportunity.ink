...
While the ship takes a short breather, you peruse some of the non-urgent messages and come across an intriguing advertisement. The message comes from an independent tech company whose name you don't recognize. It asks that anyone willing to donate do so in order to fund an experimental project. If they raise enough money, donors will receive even greater rewards when the project pays off. Shall you donate to the cause?
...
->DONE
== Scam ==
You get nothing. After the credits leave your account, so too does the message asking for donations. Best to be more cautious of these messages in the future.
->DONE
== Ignore ==
