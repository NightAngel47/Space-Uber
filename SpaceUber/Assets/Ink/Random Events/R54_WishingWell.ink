As the ship continues on its journey it stumbles upon something thought only to be myth. A self contained miniature black hole affectionately dubbed the "Wishing Well". Stories say that if you relinquish something to the well that it will bless you with good fortune, but that’s only a story right?
+[Eject Food]->Food
...
== Food ==
You eject the food into the hungry maw and it disappears without a trace. The crew seem pleased with this outcome, even though they may go hungry later.
+[Eject Food]->Food
+[Eject Power Cells]->Power
+[Eject Crew]->Crew
+[Leave]->Leave
