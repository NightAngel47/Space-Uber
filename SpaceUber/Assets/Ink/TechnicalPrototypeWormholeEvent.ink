...
=== Shuffle ===
As you approach the umbral blot, the alarms start blaring and the gravitational pull spikes. The closer end of the ship is wrenched into the void, and the ship begins to spin wildly. Your crew grip onto the walls and retch. When the spinning comes to a stop you realize that the wormhole is behind you now. Strangely, the plants onboard are significantly overgrown, overproducing food, and a few members of your crew have aged by a few months.
->END