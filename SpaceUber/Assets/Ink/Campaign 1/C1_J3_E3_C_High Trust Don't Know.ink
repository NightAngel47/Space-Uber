...
As you approach the resort planet, the VIPs carouse and debate in their lounge. A few suggest that they should only stick around the resort a couple days, one man citing a small drop to company profits in his absence. The room boos and shouts them down, set on spending a couple weeks in their hedonism. Instead it’s suggested that a game could be made of the dropping profits, the clones who underperform could be sent for and turned into punching bags, many of the VIPs joke that they’ve always wanted to punch each other out.
...
You land directly in the abandoned docking bay the clones pointed you to, a huge circular room with no roof, a tangle of shadows and catwalks along its walls. Your passengers step out of the cargo hold, their confusion over the party cut off by gunshots. Half of them crumple the ground, dead. The ensuing scattering of the suits is punctuated by further shots, as mercenaries slink from the shadows of the docking bay and move between the still struggling bodies.
