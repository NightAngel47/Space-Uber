You have reached Kellis Central HQ, a structure so large the word "colossal" would be considered a disservice. The interior is a veritable maze of flight-paths and connective corridors. Somewhere in that labyrinth a project is underway to seize control of Portunus, and with it, the world. 
Before you, however, a blockade stretches to each horizon. Unlike your ship, the warships ahead were built for conflict. Kuon sighs at the readout, expecting odds like these. Overpowering even one of those behemoths would be a considerable challenge. The blockade hails you, and asks for your identification. You will have no doubt been labled as a rogue project at this point. Kill-on-sight orders are likely in effect. You freeze.
...
A beam of energy spikes from the ship and sweeps across the blockade, slicing about twenty warships in half. All hell breaks loose. The wall of ships opposing you has shattered, the survivors charging full-speed towards Portunus. This is your chance, and you take it without a moment's hesitation.
-> Dogfight

==Dogfight==
Small ships, close in size to your own, pour from their hangars and obstruct the way forward. Beyond them lies a prime entrance into Central. The opposition's weapons do not take the time to request your identification, and open fire upon your ship. There's no other way, the ship will have to face this challenge head-on.
*[Deflect Shots]
->Deflect_Dogfight
*[Fight]
->Fight_Dogs
...
==Final_Choice==
All that's left now is to finish this.
...
==Bomb_Ending==
Kellis and the alien ship's continued existence is a threat to not only you and your crew, but to people across the galaxy. And while you can't destroy the company entirely, you can deal a debilitating blow. Having the opportunity, you decide to grasp it. 
...
It's over. The only threat your sensors can pick up is your proximity to the new tear in space and time. The main body of Kellis is gone, the transmition of the CEO's memories lost forever in that expanding abyss. The remaining pieces can be dealt with in time. For now, you and your crew can rest.
->END

==Hack_Ending==
You decide to leave the alien artifacts to their rightful owner. It's power is not meant for Kellis, yourself, or anyone else. You ignore them and plug into the hacking tool into the vault's terminals. It immediately seems to recognize the idea, and spreads itself across the company network. Every time they refused to offer aid until it was profitable, every patent for stolen tech, every violation of basic human rights, it's all there. 
As you you move through the path you cut in Kellis HQ, the hacking AI mass broadcasts this data, endless criminal noise exposing the crimes of the largest company in the galaxy. It will take days for the public to sort through, but every word is true. 
What remains of Kellis is stormed by Galatic Government authorities, backed by the companies who want to end Kellis' many monopolies. Their assets are seized, their officials arrested, and the CEO's cloning rig is shut down before he can reincarnate. You won't have to worry much about any of the remnants seeking retribution.
...
==Control_Ending==
The CEO was close to gaining control. Very close. You realize that you can very easily finish what he started. You reach out, and your mind expands. The history of every civilization before humanity rush through your peripheries. Portunus' oppressive voice fades into yours.
With the alien ship in your control, you leave the HQ behind. Using its ancient wisdom you can forge weapons behind human understanding, warp instantenously across the universe, create matter out of nothing. 
...
==Leave_Ending==
You decide to leave the alien artifacts to their rightful owner. It's power is not meant for Kellis, yourself, or anyone else. You follow the path you cut across the labyrinth and breach back into the void of space. As you navigate the wreckage of the blockade, Portunus continues to fire against Central HQ, despite heavy damage, as if consumed by rage.
You and your crew will have to decide upon where to go next. While Kellis is fractured, there are still many branches that still exist, some of which may seek retribution. Lexa says you should go on the offensive, but maybe going into hiding is a better option. Whatever the choice, it isn't one to be made right now.
